    ...
    fetch('./events_deep_data.json')
        ...
        .then(data => {
            ...
            data.forEach((event, index) => {
                ...
                // ప్రతి కార్డ్ క్లిక్ చేస్తే లీక్‌డక్ లింక్ ఓపెన్ అయ్యేలా <a> ట్యాగ్ యాడ్ చేశాను
                const cardLink = document.createElement('a');
                cardLink.href = event.link || "https://leakduck.com/events/";
                ...
                cardLink.innerHTML = `
                    <div class="pogo-event-card" style="cursor: pointer; transition: transform 0.2s;">
                ...
                // కార్డ్ పైకి వెళ్ళినప్పుడు చిన్న యానిమేషన్ ఎఫెక్ట్
                cardLink.addEventListener('mouseenter', () => { cardLink.firstElementChild.style.transform = 'scale(1.02)'; });
                cardLink.addEventListener('mouseleave', () => { cardLink.firstElementChild.style.transform = 'scale(1)'; });
        ...
        .catch(() => {
            if(grid) {
                grid.innerHTML = `<div style="color:#ff3e3e; font-size:12px; text-align:center; padding:10px;">⚠ Live Events Data is syncing via GitHub Actions. Please check back soon!</div>`;
            }
        });
}
